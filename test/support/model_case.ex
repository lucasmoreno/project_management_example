defmodule ProjectManagementExample.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import ProjectManagementExample.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&ProjectManagementExample.ErrorHelpers.translate_error/1)
